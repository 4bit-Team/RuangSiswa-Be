...
export class ConsultationCategoryService {
  constructor(
    ...
    private readonly categoryRepository: Repository<ConsultationCategory>,
  ) {}

  async create(createDto: CreateConsultationCategoryDto) {
  ...
  async update(id: number, updateDto: UpdateConsultationCategoryDto) {
