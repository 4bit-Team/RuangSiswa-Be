...
export declare class ViolationService {
    ...
    constructor(violationRepo: Repository<Violation>, categoryRepo: Repository<ViolationCategory>, spLetterRepo: Repository<SpLetter>, progressionRepo: Repository<SpProgression>, excuseRepo: Repository<ViolationExcuse>, statsRepo: Repository<ViolationStatistics>, spPdfService: SpPdfService, walasApiClient: WalasApiClient);
    reportViolation(dto: ReportViolationDto): Promise<Violation>;
    syncViolationsFromWalas(startDate: Date, endDate: Date, forceSync?: boolean): Promise<{
        success: boolean;
