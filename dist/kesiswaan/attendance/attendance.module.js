...
exports.AttendanceModule = AttendanceModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([attendance_record_entity_1.AttendanceRecord, attendance_summary_entity_1.AttendanceSummary, attendance_alert_entity_1.AttendanceAlert]),
            axios_1.HttpModule,
            config_1.ConfigModule,
        ],
        controllers: [attendance_controller_1.AttendanceController],
        providers: [attendance_service_1.AttendanceService, walas_api_client_1.WalasApiClient],
