...
export declare class TardinessService {
    ...
    constructor(recordRepo: Repository<TardinessRecord>, appealRepo: Repository<TardinessAppeal>, summaryRepo: Repository<TardinessSummary>, alertRepo: Repository<TardinessAlert>, patternRepo: Repository<TardinessPattern>);
