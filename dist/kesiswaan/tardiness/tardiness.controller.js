...
let TardinessController = class TardinessController {
    ...
    async sync(body) {
        try {
            const result = await this.tardinessService.syncTardinessFromWalas(new Date(body.start_date), new Date(body.end_date), body.force_sync || false);
            return {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], TardinessController.prototype, "sync", null);
__decorate([
