export declare class GuidanceCategory {
    id: string;
    name: string;
    code: string;
    description: string;
...
export declare class GuidanceSession {
    id: string;
...
export declare class GuidanceNote {
    id: string;
    guidance_case_id: string;
    student_id: number;
    note_content: string;
...
export declare class GuidanceIntervention {
    id: string;
    guidance_case_id: string;
    student_id: number;
...
export declare class GuidanceProgress {
    id: string;
    guidance_case_id: string;
    referral_id: string;
    student_id: number;
...
export declare class GuidanceReferral {
    id: string;
    guidance_case_id: string;
    student_id: number;
    student_name: string;
...
export declare class GuidanceStatistics {
    id: string;
    tahun: number;
...
export declare class GuidanceAbility {
    id: string;
    guidance_case_id: string;
    skill_type: string;
...
export declare class GuidanceTarget {
    id: string;
    guidance_case_id: string;
...
export declare class GuidanceStatus {
    id: string;
    guidance_case_id: string;
    student_id: number;
    tahun: number;
