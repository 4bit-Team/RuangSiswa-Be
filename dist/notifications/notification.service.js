    ...
    async create(createNotificationDto) {
        try {
            ...
            try {
                ...
                this.logger.warn(`Failed to broadcast notification via WebSocket: ${wsError.message}`);
            }
        ...
        try {
            ...
            savedNotifications.forEach((notification) => {
                try {
                    ...
                    broadcastErrors++;
                    this.logger.warn(`Failed to broadcast notification to user ${notification.recipient_id}: ${wsError.message}`);
                }
            });
            this.logger.log(`${savedNotifications.length} notifications created (${broadcastCount} broadcasted, ${broadcastErrors} broadcast errors)`);
